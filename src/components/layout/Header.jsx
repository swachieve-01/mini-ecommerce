			...
			<div className="header-inner">
				<div className="header-top">
					<NavLink to="/" className="logo">
						<img src="/assets/images/logo.svg" alt="Nature Glow 로고" className="logo-image" />
				...
				<div className="category-area" onMouseLeave={() => setHoveredCategory(null)}>
						...
						<ul className="main-category">
							{categoryData.map((category) => {
								...
								return (
									...
									>
										<NavLink to={category.path} className={({ isActive }) => (isActive ? "nav-active" : "")}>
											{category.name}
										</NavLink>
									</li>
								);
							...
							<ul className="sub-category-list">
								{hoveredCategory.subCategories.map((subCategory) => (
									<li key={subCategory.path}>
										<NavLink to={subCategory.path} className={({ isActive }) => (isActive ? "nav-active" : "")}>
											{subCategory.name}
										</NavLink>
									</li>
								))}
